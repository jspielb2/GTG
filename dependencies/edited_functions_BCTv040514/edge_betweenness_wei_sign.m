function [EBC_pos,EBC_neg,BC_pos,BC_neg] = edge_betweenness_wei_sign(L)
...
%
%   EBC_pos = edge_betweenness_wei_sign(L)
%   [EBC_pos,EBC_neg,BC_pos,BC_neg] = edge_betweenness_wei_sign(L)
%
